...
* [Qt 6.6.0 or higher](https://www.qt.io/download-open-source#hs_cos_wrapper_widget_1567539130992) - currently using v6.8.3
...
> [!NOTE]
> TagLib 2.0.0 or higher is technically also a dependency but is automatically downloaded and configured via CMake.
