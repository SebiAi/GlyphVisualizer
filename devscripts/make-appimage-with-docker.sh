...
# Run docker container as current user and make AppImage
sudo docker run -u $(id -u):$(id -g) --rm -v "${PROJECT_DIR}:/project" "${IMAGE_NAME}" bash /project/devscripts/make-appimage.sh